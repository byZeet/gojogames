    ...
    <div className="min-h-screen bg-[#151515] text-white flex justify-center items-center py-10 px-4">
      <div className="w-full md:w-3/4 lg:w-[90%] flex flex-col">
        <div className="mb-4 flex justify-start">
          <Link href="/" className="bg-[#3B82F6] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-[20px] flex items-center gap-2">
            <Image src={arrowleft} alt="Volver atrás" width={20} height={20} />
            <span>Volver atrás</span>
          </Link>
        </div>
        <div className="flex flex-col lg:flex-row bg-[#202020] p-4 md:p-6 rounded-lg shadow-lg">
              ...
              <div className="flex flex-col gap-4">
                {suggestedGames.map((suggestedGame) => (
                  <Link href={`/games/${suggestedGame._id}`} key={suggestedGame._id}>
                    <div className="bg-[#303030] p-2 rounded-lg shadow-lg flex flex-col cursor-pointer hover:bg-[#3A3A3A]">

  ...
  return (
    <main className='container-payment'>
      ...
      <section className="h-full w-full p-5 pt-28">
        <div className="container-pago w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          {/* Contenedor de las tarjetas con desplazamiento vertical */}
          <div className="flex flex-col gap-3 max-h-[calc(100vh-560px)] overflow-y-auto">
            {/* CARD COMPRA */}
            {[...Array(5)].map((_, index) => (
              <div key={index} className="tarjeta-juego-carrito grid grid-cols-1 lg:grid-cols-2 min-[550px]:gap-6 custom-border-gray py-6">
          ...
          {/* Sección del subtotal, impuestos y total */}
          <div className="bg-custom-cart rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
            <div className="flex items-center justify-between w-full mb-6">
              ...
              <h6 className="font-semibold text-xl leading-8 text-gray-400">360€</h6>
            </div>
            <div className="flex items-center justify-between w-full pb-6 border-b custom-border-gray">
              ...
              <h6 className="font-semibold text-xl leading-8 text-gray-400">0%</h6>
            </div>
        ...
        {/* Botones de volver atrás y realizar pago */}
